...
//           backButton.anchor(top: containerView.topAnchor, left: containerView.leftAnchor, paddingTop: 16, paddingLeft: 16, width: 25, height: 30)
           ...
           let stackView1 = UIStackView(arrangedSubviews: [aphakiaSegmentedView , catractSegmentedView , choroidalEffusionSegmentedView , choroidalHemorrhageSegmentedView , diabeticTRDSegmentedView , dislocatedIntraocularLensSegmentedView , endophthalmitisSegmentedView , epiretinalMembraneSegmentedView , fevrSegmentedView , floatersSegmentedView , fullThicknessMacularHoleSegmentedView , intraocularForeignBodySegmentedView , lamellarMacularHoleSegmentedView , latticeDegenerationSegmentedView , pdrSegmentedView , primaryRdWithPVRSegmentedView , recurrentRdWithPVRSegmentedView , recurrentRdWithoutPVRSegmentedView , retainedLensFragmentsPVRSegmentedView , retinalTearSegmentedView , retinalVeinOcclusionSegmentedView , rhegmatogenousRdMaculaOffSegmentedView, rhegmatogenousRdMaculaOnSegmentedView , ropSegmentedView, sickleCellSegmentedView , spRdRepairWithSiliconeOilSegmentedView , subluxedCrystallineLensSegmentedView , vitreousHemorrhageSegmentedView , retinalDefectSegmentedView ] )

...
class ExportBySurgeryViewController: UIViewController {
    ...
    var dataList = ["Select Surgery","Virectomy","Scleral buckle", "Membrane peel", "ILM peel", "Retinectomy" , "Fluid-Air-Exchange" , "PFO" ,"Focal Endolaser", "PRP Laser" , "Indirect Laser Tear/Lattice" , "IOL Exchange","IOL Insertion" , "ACIOL" ,"Sulcus IOL" , "Scleral Fixated IOL Sutured" , "Scleral Fixated IOL Sutueless" , "PPL" ,"PPL with Frag" , "Silicone Oil Removal" , "Silicone Oil Exchange" ,"Choroidal Drainage" , "IOL Reposition" , "Cryotherapy"]
    var selectedItem = ""
    var queryStatus = 0
